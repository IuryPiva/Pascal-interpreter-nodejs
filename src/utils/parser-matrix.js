module.exports = {
	...
	"54,5":["NULL"],
	"54,6":["NULL"],
	"55,25":["IDENTIFIER","REPIDENT"],
	"56,39":["NULL"],
    "56,46":[",","IDENTIFIER","REPIDENT"],
    "56,47":["NULL"],
	"57,3":["CONST","IDENTIFIER","=","INTEGER",";","LDCONST"],
	"57,4":["NULL"],
	"57,5":["NULL"],
	"57,6":["NULL"],
	"58,4":["NULL"],
	"58,5":["NULL"],
	"58,6":["NULL"],
	"58,25":["IDENTIFIER","=","INTEGER",";","LDCONST"],
	...
	"61,8":["INTEGER"],
	"61,9":["ARRAY","[","INTEGER","..","INTEGER","]","OF","INTEGER"],
	"62,5":["PROCEDURE","IDENTIFIER","DEFPAR",";","BLOCO",";","DCLPROC"],
	"62,6":["NULL"],
	"63,36":["(","LID",":","INTEGER",")"],
	"63,39":["NULL"],
	...
	"66,6":["CORPO"],
	"66,7":["NULL"],
	"66,11":["CALL","IDENTIFIER","PARAMETROS"],
	"66,12":["GOTO","IDENTIFIER"],
    ...
    "66,25":["IDENTIFIER","RCOMID"],
	"66,27":["FOR","IDENTIFIER",":=","EXPRESSAO","TO","EXPRESSAO","DO","COMANDO"],
	...
	"83,26":["INTEGER"],
	"83,36":["(","EXPRESSAO",")"],
	"84,26":["INTEGER","RPINTEGER",":","COMANDO","CONTCASE"],
	"85,7":["NULL"],
	"85,47":[";","CONDCASE"],
	"86,39":["NULL"],
	"86,46":[",","INTEGER","RPINTEGER"],
